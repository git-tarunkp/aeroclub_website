...
function Addclubheads() {
    ...
    const handleUpload=(e)=>{
      ...
      axios.post('http://localhost:3001/uploadclubheads',formdata)
    ...
    const handleDelete=(id) =>{
      axios.delete("http://localhost:3001/deleteclubheads/"+id)
      .then(res => {console.log(res)
          window.location.reload()
      })
      .catch(err=>console.log(err))
